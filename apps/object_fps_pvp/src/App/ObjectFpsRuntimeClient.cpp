...
struct ObjectFpsBindings final {
    InputAxisId moveForward{InputAxisId::FromString("object_fps_pvp.move.forward")};
    InputAxisId moveRight{InputAxisId::FromString("object_fps_pvp.move.right")};
    InputAxisId lookX{InputAxisId::FromString("object_fps_pvp.look.x")};
    InputAxisId lookY{InputAxisId::FromString("object_fps_pvp.look.y")};
    InputActionId fire{InputActionId::FromString("object_fps_pvp.fire")};
    InputActionId reload{InputActionId::FromString("object_fps_pvp.reload")};
    InputActionId jump{InputActionId::FromString("object_fps_pvp.jump")};
    InputActionId holster{InputActionId::FromString("object_fps_pvp.holster")};
    InputActionId menuPrevious{
        InputActionId::FromString("object_fps_pvp.menu.previous")};
    InputActionId menuNext{InputActionId::FromString("object_fps_pvp.menu.next")};
    InputActionId menuAdjustPrevious{
        InputActionId::FromString("object_fps_pvp.menu.adjust_previous")};
    InputActionId menuAdjustNext{
        InputActionId::FromString("object_fps_pvp.menu.adjust_next")};
    InputActionId confirm{InputActionId::FromString("object_fps_pvp.menu.confirm")};
    InputActionId back{InputActionId::FromString("object_fps_pvp.menu.back")};
};
