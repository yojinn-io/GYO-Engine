...
include("${repository}/cmake/GyoAppRegistry.cmake")
...
execute_process(COMMAND "${CMAKE_COMMAND}" "-DGYO_REGISTRY_FILE=${csv}"
    -P "${repository}/cmake/ExportAppRegistry.cmake"
...
execute_process(COMMAND "${CMAKE_COMMAND}" -S "${fixture}" -B "${work}/project-build"
    ${generator_args} "-DREGISTRY_MODULE=${repository}/cmake/GyoAppRegistry.cmake" -DSELECTION=AUTO
